...
MINIO_JS_VERSION=$(curl --retry 10 -Ls -o /dev/null -w "%{url_effective}" https://github.com/prakashsvmx/minio-js/7.0.17 | sed "s/https:\/\/github.com\/prakashsvmx\/minio-js\/releases\/tag\///")
